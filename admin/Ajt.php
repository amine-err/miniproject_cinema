  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="Ajt.php" style="font-weight: bold">Nouveau</a>
        </li>
        <li class="nav-item">
...
if (isset($_POST['bb'])) {
    try{
    $req=$connexion->prepare("INSERT INTO films (imagee,nom,prix,descri,idGenre,annee,duree,resumé,projection) VALUES (?,?,?,?,?,?,?,?,?)");
