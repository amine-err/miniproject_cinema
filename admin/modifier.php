  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link " aria-current="page" href="#" style="font-weight: bold; color:green; ">Modification</a>
        </li>
...
$id=$_POST['id'] ; 
try{
  $req=$connexion->prepare("UPDATE films SET imagee=? , nom=? , prix=? , descri=? , idGenre=? , annee=? , duree=? , resumé=? , projection=? WHERE id=id");
